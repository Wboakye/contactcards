								...
								<div className="row w-100">
									...
									<div className="col-12 col-sm-6 col-md-9 text-center text-sm-left">
										<div className=" float-right">
											<button className="btn" onClick={() => this.props.history.push('/edit/' + index)}><i className="fas fa-pencil-alt"></i></button>
											<button className="btn" onClick={() => actions.deleteItem(item.id)}><i className="fas fa-trash-alt"></i></button>
										</div>
